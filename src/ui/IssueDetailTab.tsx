...
export function IssueDetailTab({ context }: PluginDetailTabProps) {
  ...
  if (!data) return <div style={{ padding: 16, color: "var(--muted-text, #9ca3af)" }}>Not linked to GitHub</div>;

  return (
    <div style={{ padding: 16 }}>
      <h3 style={{ marginBottom: 12 }}>GitHub Issue</h3>
      <div style={{ marginBottom: 12 }}>
        <div style={{ fontSize: 12, color: "var(--muted-text, #6b7280)", marginBottom: 4 }}>Reference</div>
      ...
      {data.prRef && (
        <div style={{ marginBottom: 12 }}>
          <div style={{ fontSize: 12, color: "var(--muted-text, #6b7280)", marginBottom: 4 }}>Pull Request</div>
      ...
      {data.lastSyncedAt && (
        <div style={{ fontSize: 12, color: "var(--muted-text, #9ca3af)" }}>
